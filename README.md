...
The attendance list was discovered hard-coded in the HTML of the official dialog.org website. The leak was subsequently fixed by the website owners.

I captured the website's HTML at the time of the leak, which included the names of the club's members.

Though I am unaware of any nefarious activity by the organisation, I find it interesting how many influential individuals were part of the society and would simply like to preserve the attendance list here in this repository.
